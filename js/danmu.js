var arr = ["一本正经的胡说八道","男神的弹幕我承包","小天使你要是消失了,我就陪你消失","666","2333~~~~~","程序有问题时不要担心"];               //用来保存弹幕数据的数组
...
//获取随机颜色的最高级写法 http://www.jb51.net/article/35931.htm
  ...
  var getRandomColor = function(){
	...
	var containTime=function(){
		return Math.random()*800+600;
	}
  var runDanMu = function(){
    ...
    setTimeout(runDanMu,containTime());
  }
